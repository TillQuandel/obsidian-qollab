...
| --- | --- | --- |
| gebrochen | 41 | aktiv schlechter oder verletzt ein Kriterium |
...
| `M-06` | Herkunftstor schaerfen (Hebel B, istEigen an den Doc-Stand binden) | offen | am echten pathQueue haelt der Gewinn, schrumpft aber mit der Umordnungsrate: Textverlust 95 auf 62 bei 0,4 % Umordnungen, 323 auf 296 bei 4,00 %, 677 auf 647 bei 7,03 %. Divergenz und Grundtextverlust bleiben 0 - aber JEDE ueberholte eigene Bearbeitung wird geparkt | nachlaufbar |
...
**Kennzahl:** am echten pathQueue haelt der Gewinn, schrumpft aber mit der Umordnungsrate: Textverlust 95 auf 62 bei 0,4 % Umordnungen, 323 auf 296 bei 4,00 %, 677 auf 647 bei 7,03 %. Divergenz und Grundtextverlust bleiben 0 - aber JEDE ueberholte eigene Bearbeitung wird geparkt  
**Zellbasis:** 200 Seeds x 3 Seed-Familien (DET 7/42/99) x 5 Verzoegerungsstufen, N=4, gepaart; Kalibrierungsarm ohne Warteschlange zahlengleich mit der Messung vor dem Umbau

DIE LUECKE IST GESCHLOSSEN, das Urteil bleibt offen - aber mit sehr viel mehr Wissen als vorher. Der Apparat verglich bis zum 2026-08-15 synchron; jetzt laeuft die ECHTE PathQueue aus src/ zwischen merke() und istEigen(), und die Handler-Laufzeit ist als Regler gefuehrt (SPIKE_VERZOEGERN, in Transportschritten). DER GEWINN HAELT, ER SCHRUMPFT NUR. Ueber alle drei Seed-Familien gleichfoermig: bei 0,4 % Umordnungen -33 bis -35 %, bei 2 % -21 bis -32 %, bei 4 % -8 bis -10 %, bei 7 % -3 bis -5 %. Er wird also nie negativ, ist aber ab etwa 4 % das Risiko nicht mehr wert. Grundtextverlust bleibt 0 in allen 30 Zellen, Divergenz ebenfalls 0 - auch bei 451 fehlgeparkten Bearbeitungen. DIE FEHLPARKUNG IST REAL UND VOLLSTAENDIG. Nicht "mehr als gemessen", wie die Akte vorsichtig formulierte, sondern praktisch JEDE ueberholte eigene Bearbeitung - 31 von 31, 100 von 102, 270 von 298. Das ist kein Zufall, sondern eine Eigenschaft der Regel: Tor-Kollision und Fehlparkung sind am Doc-Stand nicht unterscheidbar. Beide Male steht unser Text in der .md und der Doc ist seit unserem Write vorausgelaufen; verschieden ist allein die Reihenfolge von Zustellung und Vorlauf, und die traegt der Doc-Stand nicht. SIE KOSTET ABER NICHTS. Das ist der eigentliche Befund: 451 Fehlparkungen bei Divergenz 0 und weiterhin positivem Nutzen. Der naheliegende Grund ist, dass ein geparkter Stand einen billigen Rueckweg hat - 59,5 bis 89,3 % der Parkvorgaenge enden, indem die Historie eintrifft und den Stand deckt (resolveParked, keine Op), nur der Rest laeuft in den unionMerge-Nachtrag. ALS URSACHE IST DAS NICHT BELEGT, und die Spanne widerspricht der einfachen Lesart: der Anteil ist bei kleiner Verzoegerung am schlechtesten (59,5 %) und in der Mitte am besten (89,3 %). EINE EIGENE FEHLDEUTUNG DIESER SESSION, ausdruecklich. Ein erster, frei laufender Arm (nichts wird je abgewartet) zeigte B als GEBROCHEN - Textverlust 328 auf 345, Divergenz 8 auf 33 -, und das Verdikt stand einige Stunden so in dieser Registratur. Es haelt nicht, und zwar aus einem einzigen, ausreichenden Grund: Der Bestand verliert dort das Vierfache (328 statt 95). Ein Arm, der die Vergleichsseite vervierfacht, misst nicht mehr den Kandidaten - siehe X-10. WARUM in diesem Arm zusaetzlich Divergenz entsteht, ist NICHT geklaert; die naheliegende Erklaerung ueber den Anteil abgelaufener Parkvorgaenge traegt nicht (37 % dort gegen 10,7 bis 40,5 % im kontrollierten Arm, der bei Divergenz 0 bleibt). Die dort beobachtete Kopplung "Divergenz haengt an der Fehlparkung" (24 von 25 Seeds) war eine Korrelation INNERHALB dieses Arms; im kontrollierten Arm gibt es 451 Fehlparkungen bei Divergenz 0. DIE HASH-FRAGE IST GEGENSTANDSLOS. Die Akte verlangte, die Doc-Marke muesse ein Hash sein statt eines vollen Doc-Texts. Das betrifft den Speicher, nicht die Entscheidung - dieselbe Vergleichsregel in billig. EINE ZWEITE KORREKTUR AN DER AKTENLAGE. Der Satz "loest K.o.-1 nur in einer von drei Seed-Familien" beschrieb einen Bestand, der selbst 1/2/1 Grundtextzeilen verlor - den Stand vor T-04 und T-05. Heute steht WEG=0 schon im Bestand, in allen Familien und in jedem Arm. WAS VOR EINEM EINBAU FEHLT, und nur das: die UMORDNUNGSRATE IM FELD, also wie oft der modify-Handler eines eigenen Edits hinter einer anderen Doc-Mutation desselben Pfades landet. Unterhalb von etwa 2 % ist B klar im Plus, oberhalb von 4 % nicht mehr. Diese Zahl ist im Apparat nicht zu gewinnen - sie haengt an Plattenlatenz, Notizgroesse und Sync-Intervall und gehoert an echtes Obsidian (r30). DAS INSTRUMENT, mit drei Gegenproben. schnitte.mjs fuehrt die Warteschlange als Option und die Handler-Laufzeit als Regler; benutzt wird die ECHTE PathQueue aus src/, kein Nachbau. Erstens liefert der Arm ohne Warteschlange zahlengleiche Zeilen mit der Messung vor dem Umbau (alle zwoelf Zellen). Zweitens liegt der Diagnose-Arm mit Warteschlange, aber ohne Nebenlaeufigkeit mit 95 gegen 86 praktisch auf dem alten Arm - der Umbau ist inert. Drittens meldet der Arm BLIND, wenn der Doc nie vorauslief.

*Beleg: obsidian-qollab-doku/sdd/runs/m06-kipppunkt-20260815.log (die Kurve), m06-warteschlange-20260815.log (der frei laufende Arm), m06-takt-20260815.log (Inertheitsprobe), m06-kalibrierung-20260815.log; Bericht sdd/m06-pathqueue-2026-08-15.md — nachlaufbar*
...
| `T-04` | Zeilenweiser Drei-Wege-Merge gegen die Basis | eingebaut | Grundtext 23 auf 0, Gesamtverlust -18,3 %, Verdopplung -6,5 %, Divergenz 2 auf 1; 566/566 Tests gruen. Die drei Achsen am 2026-08-14 nachgemessen: WEG 0 gegen 36 | nachlaufbar |
...
| `T-09` | Ohne Schluss-Umbruch verdoppelt setContent die letzte Zeile | eingebaut | Stapelung der unberuehrten Schlusszeile 2743 von 4000 auf 0; am Nachbau 210 auf 184 Zeichen, BBB 2x auf 1x; Suite 608 auf 615 gruen, kein Rueckschritt | nachlaufbar |
...
**Kennzahl:** Grundtext 23 auf 0, Gesamtverlust -18,3 %, Verdopplung -6,5 %, Divergenz 2 auf 1; 566/566 Tests gruen. Die drei Achsen am 2026-08-14 nachgemessen: WEG 0 gegen 36  
**Zellbasis:** 8 Zellen a 200 Seeds x 10 Notizen; kein Rueckschritt in einer einzigen Zelle. Achsen-Nachmessung 2026-08-14 - 8 Zellen a 200 Seeds, gepaart gegen den Stand vor T-05

Weil auf ZEILEN gearbeitet wird, kann keine Operation mehr eine fremde Zeile aufbrechen — das war die Schadensmechanik des Zeichen-Diffs. Der Hinweis stand seit Wochen im eigenen Messapparat. Erledigt auch die drei Achsen, an denen der Fix vom 2026-08-10 nicht trug (N >= 5, grosse Notizen, mdModus ueberschreiben). DIESER SATZ WAR BIS ZUM 2026-08-14 UNBELEGT und stand neben einer Tabelle in produktziel.md, die das Gegenteil sagte ("Verlust in allen 8 Zellen"). Welche acht Zellen T-04 gemessen hat, steht nirgends - dasselbe Muster wie X-08, wo eine an einem Fall gemessene Wirkung fuer einen zweiten mitbehauptet wurde und dort NICHT trug. Nachgemessen mit spike/schnitt/t04-achsen.mjs, 200 Seeds je Zelle, acht Zellen ueber genau diese drei Achsen: WEG = 0 im heutigen Stand gegen 36 im Stand vor T-05 (N=6 elf, N=8 achtzehn, mdModus ueberschreiben vier, N=4 drei). Der Satz haelt also - er war nur nie nachgerechnet. Die Gegenprobe laeuft fest im Instrument mit: Es startet sich selbst mit QOLLAB_DIFF_MODUS=semantisch und meldet BLIND, wenn auch die alte Fassung nichts zeigt. Ohne sie waere "WEG = 0" von "der Apparat erzeugt die Lage nicht" nicht zu unterscheiden - der erste Anlauf dieser Messung war genau das, und der eingefrorene Kalibrierungsarm real.cjs half nicht: Er laesst sich mit dem heutigen schnitte.mjs gar nicht mehr fahren (kein parkedPaths), ist fuer solche Vergleiche also tot. WAS DIE MESSUNG NICHT SAGT: Die Verdopplung bleibt und waechst mit N (839 auf 4.581 ueber N=4 bis N=8), und die Quote vollstaendig sauberer Laeufe faellt von 198/200 bei N=2 auf 0/200 bei N=8. Grundtext haelt; "sauber" ist etwas anderes. Bekannte Grenzen - diff3 ist formal nicht idempotent (24,7 % der Faelle, Bestand 100 %), Konvergenz nicht garantiert (13,7 % der Merge-Reihenfolgen liefern verschiedene Texte).
...
**Hypothese:** — (Produktbefund, kein Kandidat). Endet ein Text NICHT auf einem Zeilenumbruch, ist seine letzte Zeile beim naechsten setContent keine unberuehrte Zeile mehr, sondern eine geaenderte - `diff_linesToChars_` tokenisiert inklusive Zeilenende, und "BBB" ist ein anderes Token als "BBB\n". diffOps loest das als DELETE der alten plus INSERT der neuen Zeile. Rechnen zwei Geraete das unabhaengig, verschmelzen die DELETE-Haelften und die INSERT-Haelften stapeln sich.

**Verdikt:** eingebaut · **2026-08-14**

**Kennzahl:** Stapelung der unberuehrten Schlusszeile 2743 von 4000 auf 0; am Nachbau 210 auf 184 Zeichen, BBB 2x auf 1x; Suite 608 auf 615 gruen, kein Rueckschritt  
**Zellbasis:** 4.000 gepaarte Fuzzer-Runden je Fassung (Seed 20260814, Alphabet mit Surrogatpaaren, CRLF und Leerzeilen), plus harness-freier Nachbau der r14-Lage gegen beide Fassungen; 7 neue Unit-Tests

Die Ursache des einen roten Runners der Batterie (X-08). GEFUNDEN ueber die Itemkette, nicht ueber die Merge-Funktionen: verify.js meldet fuer die verklebte Zeile ZWEI clientIDs, waehrend jede andere Zeile genau eine traegt. r14-items.mjs loest das auf - zwei Insert-Ops fuehren BEIDE `BBB-<RunId>` mit, und das urspruengliche BBB-Item steht in beiden Vaults als Tombstone da. DIE BEDINGUNG IST DER FEHLENDE SCHLUSS-UMBRUCH, NICHT DIE GERAETEZAHL. Das ist die Korrektur an der Aktenlage: produktziel.md fuehrt dieselbe Mechanik unter "Was ab vier Geraeten uebrig bleibt" und nennt N=2 "strukturell aus". Hier tritt sie bei N=2 auf. Nicht die Zahl der Geraete entscheidet, sondern ob der gemeinsame Stand auf `\n` endet - und in Obsidian ist das Fehlen der Normalfall. REPRODUZIERT OHNE HARNESS. r14-ursache.mjs baut die Lage aus dem konvergierten Ausgangsstand nach, laesst beide Seiten unabhaengig je eine Zeile anhaengen und vereinigt. Ergebnis byte-gleich mit dem Endtext, den der Realtest in vault-b hinterlassen hat. Kein Transport, kein Herkunftstor, kein Sweep beteiligt - nur die Umrechnung Text -> Ops. DIE GEGENPROBE TRAEGT, in beide Richtungen: dieselbe Lage MIT Schluss-Umbruch bleibt sauber (1x statt 2x), und eine Kontrolllage, in der beide Seiten denselben neuen Text schreiben, zeigt die Verdopplung zuverlaessig - das Instrument ist nicht blind fuer die Schadensklasse. WARUM ES BISHER NIEMAND SAH. probe-idempotenz.mjs, das Instrument fuer genau diese Klasse, kann sie strukturell nicht erzeugen: seine Texte enden ausnahmslos auf `\n` (`.join(NL) + NL`). Das ist der zehnte Fall eines nachweislich blinden Messinstruments in diesem Projekt. EINORDNUNG. Verletzt Gruppe 1 ("der Text bleibt strukturell heil"), nicht K.o.-1 - es geht kein Grundtext verloren, die letzte Zeile steht doppelt. Der Schaden steht im CRDT und ist damit propagierbar. DER FIX, eingebaut am 2026-08-14 (`schlusszeileEntkleben`): Aus DELETE "BBB" + INSERT "BBB\nA2" wird EQUAL "BBB" + INSERT "\nA2" - der gemeinsame Praefix wird abgespalten, die unberuehrte Zeile behaelt ihr Item, es entsteht kein Tombstone. Drei enge Bedingungen halten den Eingriff auf den einen Fall: `current` endet nicht auf `\n`, das INSERT beginnt mit dem DELETE, und das DELETE deckt das ENDE von `current`. DER NAHELIEGENDE WEG IST GEFALLEN. `diff_cleanupMerge` loest denselben Fall, zieht gemeinsame Affixe aber UEBERALL heraus statt nur an der Schlusszeile. Die Ops sind danach zeichen- statt zeilenweise, und damit ist T-05 unterlaufen: zwei Replikate, die dieselbe Zeilenmitte aendern, erzeugen "Punkt 2: Beschlossenossen" - eine ZERRISSENE Zeile, also genau die Schadensklasse, die T-05 beseitigt hat. Gegeneinander gemessen in t09-varianten.mjs ueber sieben Pruefungen; nur der enge Weg besteht alle. ADVERSARIAL GEPRUEFT, weil T-08 nach zwei Runden noch falsch war. Ein Fuzzer ueber 4.000 gepaarte Runden je Fassung (Alphabet mit Surrogatpaaren, CRLF, Leerzeilen, praefixgleichen Zeilen) prueft zwei Eigenschaften: die INVARIANTE (nach setContent(b) steht b im Doc) haelt in beiden Fassungen 4.000/4.000 - der Eingriff bricht die Positionsrechnung also nicht -, und die STAPELUNG faellt von 2.743 auf 0. AUCH DIESES INSTRUMENT WAR ZUERST BLIND und hat es selbst gemeldet: Es zaehlte exakte Zeilen und fand nie etwas, weil der Schaden die Zeile mit der naechsten verklebt und sie danach ein anderer String ist. Gezaehlt wird jetzt im Volltext, wie H-COUNT es tut. Die 2.743 sind die Rate in diesem Alphabet, KEINE Feldrate. AM PRODUKT BELEGT am 2026-08-14: r14-cdp meldet PASS mit 24 Asserts, und `kontrolle2-keine-duplikate` ist gruen - genau das Assert, das seit dem 2026-08-12 mit 1/2/1 rot stand. Die vorhergesagte Zahl (23 gruene plus das rote) ist eingetroffen. Damit ist die Batterie ERSTMALS vollstaendig gruen: 8 von 8, Prod-Stempel vorher wie nachher gleich.

*Beleg: spike/duplikat-mb/ — r14-items.mjs (Itemkette), r14-ursache.mjs (Nachbau gegen beide Fassungen), t09-varianten.mjs (die sieben Pruefungen), t09-adversarial.mjs (der Fuzzer), bauen-crdt.mjs (beide Fassungen mit Gegenprobe); tests/schlusszeile-ohne-umbruch.test.ts; obsidian-qollab-doku/sdd/runs/ — t09-adversarial.log (die 2743), t09-ursache.log, t09-varianten.log, suite-nach-t09.log (die 615), r14-cdp-bat3-20260813-212759.log — nachlaufbar*
...
| `X-10` | Einen Kandidaten in einem Arm bewerten, der beide Vergleichsseiten verschlechtert | gebrochen | der frei laufende Arm verschlechtert den BESTAND von 95 auf 328 Zeilen Textverlust und dreht damit das Vorzeichen eines Kandidaten, der im kontrollierten Arm bei jeder gemessenen Umordnungsrate im Plus bleibt | nachlaufbar |
...
### X-09 — Serienlauf ueber r13 hinaus - der Guard blockiert den Nachfolger

**Hypothese:** Nach r13 kann die Serie ohne Weiteres weiterlaufen.

**Verdikt:** gebrochen · **2026-08-14**

**Kennzahl:** 4 der 8 Runner brechen mit 0 Asserts in 1 s ab (r14, r15, r16, r30); im Nachlauf ohne r13 dieselben vier PASS, zusammen 70 gruene Asserts  
**Zellbasis:** ein Serienlauf zu 8 Runnern, danach ein Nachlauf zu vieren

Der Guard verweigert den Kill mit "nicht als Testvault nachgewiesen: PID ... (ohne Fenstertitel, keine Elternkette zu einem Testvault-Fenster)" - und das ist richtig so. Ein Prozess, der sich nicht positiv einem Testvault zuordnen laesst, darf nicht gekillt werden; genau diese Schutzkette hat den produktiven Vault schon einmal gerettet. Der Prod-Stempel blieb in beiden Durchgaengen gleich. DER VERDACHT, ausdruecklich als solcher: r13 startet Obsidian ueber `H-START-FILE`, also per `obsidian://open` OHNE Debug-Port. Nach dem Lauf standen fuenf Prozesse offen, deren Wurzel `obsidian://open/?path=C:\tmp\qollab-test\vault-b\Meetingprotokoll.md` trug - eindeutig Testvault, aber ohne Fenstertitel und ohne Elternkette, an der der Guard das festmachen kann. Dafuer spricht, dass der Nachlauf OHNE r13 (nur r14, r15, r16, r30) glatt durchlief. Isoliert gemessen ist es nicht; es waere ein eigener Diskriminator. WAS DER FALL NICHT IST: kein Produktbefund. Die vier Runner haben nicht gemessen und nichts gemeldet - 0 gruene, 0 rote Asserts in 1 Sekunde. Ein FAIL ohne Asserts ist ein Apparat-Abbruch, kein Ergebnis. Wer die Zusammenfassung "4 von 8 PASS" ohne die Assert-Zahlen liest, haelt es fuer eine Regression. ZWEI BEDIENFEHLER derselben Runde, beide gefangen und hier notiert, weil sie Zeit kosten: (1) `H-STOP` von Hand nach dem Serienende scheitert - das abschliessende `H-GUARD-AUFRAEUMEN` hat obsidian.json zurueckgeholt, der produktive Vault steht wieder auf open:true, und der Guard verlangt zuerst `H-GUARD-SICHERUNG`. Die Kette muss von vorn beginnen, dafuer ist der Batterie-Treiber da. (2) `pwsh -File skript.ps1 -Nur a,b,c` uebergibt EINEN String, kein Array - die Batterie sucht dann einen Runner namens "a,b,c" und meldet "0 von 1". Mit `pwsh -Command "& skript.ps1 -Nur @('a','b','c')"` stimmt es.

*Beleg: obsidian-qollab-doku/sdd/runs/batterie-bat3-20260814-151843.json (4 von 8, die vier mit 0 Asserts) gegen batterie-bat3-20260814-153033.json (4 von 4) — nachlaufbar*
...
### X-10 — Einen Kandidaten in einem Arm bewerten, der beide Vergleichsseiten verschlechtert

**Hypothese:** Ein Messarm, der die fehlende Nebenlaeufigkeit endlich abbildet, ist damit auch der bessere Arm - seine Zahlen sind naeher am Produkt als die des synchronen Aufbaus.

**Verdikt:** gebrochen · **2026-08-15**

**Kennzahl:** der frei laufende Arm verschlechtert den BESTAND von 95 auf 328 Zeilen Textverlust und dreht damit das Vorzeichen eines Kandidaten, der im kontrollierten Arm bei jeder gemessenen Umordnungsrate im Plus bleibt  
**Zellbasis:** derselbe Apparat in drei Armen (synchron, kontrolliert verzoegert, frei laufend), 200 Seeds x 3 Seed-Familien, N=4

REAL BEZAHLT AM 2026-08-15, in derselben Session. Der Apparat rief istEigen() bis dahin unmittelbar nach dem Write - ein Hebel, der an den Doc-Stand bindet, KONNTE dort per Konstruktion nicht danebenliegen. Der erste Arm, der das behob, liess jede Aufgabe frei laufen: modify-Task, Fremdzustellung, Frist-Uhr, nichts wurde je abgewartet. In diesem Arm faellt M-06 klar - Textverlust 328 auf 345, Divergenz 8 auf 33. Das Verdikt "gebrochen" stand einige Stunden so in dieser Registratur. ES HAELT NICHT, und der Grund steht im Arm selbst: Er verschlechtert den BESTAND von 95 auf 328 Zeilen. Ein Arm, der die Vergleichsseite vervierfacht, misst nicht mehr den Kandidaten, sondern sich selbst. Mit einem Regler statt eines Schalters - die Handler-Laufzeit in Transportschritten, alles andere prompt - bleibt der Bestand kalibriert und der Kandidat ueber den ganzen gemessenen Bereich im Plus (-34,7 % bei 0,4 % Umordnungen bis -4,4 % bei 7,0 %), bei Divergenz 0 in allen 30 Zellen. WARUM der frei laufende Arm zusaetzlich Divergenz erzeugt, ist NICHT geklaert. Die naheliegende Erklaerung - dort laufe auch die Frist-Uhr hinterher, mehr Parkvorgaenge liefen in den teuren unionMerge-Nachtrag - ist nachgerechnet und traegt nicht: 37 % dort gegen 10,7 bis 40,5 % im kontrollierten Arm, der ueber alle 15 Zellen bei Divergenz 0 bleibt. Fuer das Verdikt reicht der erste Grund; die offene Frage gehoert trotzdem notiert, statt sie mit einer plausiblen Zahl zuzudecken. DIE REGEL DARAUS: Ein neuer Messarm gehoert zuerst gegen den alten kalibriert. Weicht die VERGLEICHSSEITE ab, ist der Arm zu erklaeren, bevor aus ihm ein Verdikt wird - sonst misst man die eigene Modellierung. Der Diagnose-Arm mit Warteschlange, aber ohne Nebenlaeufigkeit leistet genau das: er liegt mit 95 gegen 86 praktisch auf dem alten Arm. EIN VIERTER ARM WURDE GEBAUT UND WIEDER ENTFERNT. Er sollte die obere Schranke liefern, indem er die anstehende Fremdzustellung vor JEDEN Tor-Task einreiht. Er ordnet aber nicht nur um, er zieht Fremdhistorie vor: der Bestand verlor darunter 352 statt 17 Zeilen (40 Seeds, DET 7), in beiden Armen. Dieselbe Krankheit, nur groeber.

*Beleg: obsidian-qollab-doku/sdd/runs/m06-warteschlange-20260815.log (frei laufend) gegen m06-takt-20260815.log (Inertheitsprobe) gegen m06-kipppunkt-20260815.log (die Kurve); Bericht sdd/m06-pathqueue-2026-08-15.md — nachlaufbar*
