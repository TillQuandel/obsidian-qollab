...
| `T-09` | Ohne Schluss-Umbruch verdoppelt setContent die letzte Zeile | offen | ohne Schluss-Umbruch steht die letzte Zeile 2x (210 Zeichen, byte-gleich mit dem Realtest r14cdp-20260813-213723); mit Schluss-Umbruch 1x (185 Zeichen) | nachlaufbar |
